...
import com.microservice.transaction.BusinessRules.ValidationResponse;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<APIResponse<Map<String,String>>> handleValidationException(WebExchangeBindException ex) {
	    ...
	    APIResponse<Map<String,String>> resp =
	            new APIResponse(
	                    ...
	                    BusinessError.Validation_Error_MSG,
	                    error_map
	            );
